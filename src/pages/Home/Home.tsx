export default function Home() {
	...
	return (
		<section className="relative mx-auto max-w-[450px] xs:max-w-[600px] sm:max-w-[800px] md:max-w-[1460px]">
			<div className="rounded-[20px] bg-black/75 mx-2 xs:mx-0 xs:h-[40vh] sm:h-[60vh] border-2 md:h-[87vh]">
				<div className="flex">
					<img
						alt="home img"
					...
					/>
					<div className="absolute right-4 top-10 md:right-10 xs:top-[7rem] sm:top-4 md:top-10 text-white">
