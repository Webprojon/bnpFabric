		...
		<section className="mt-16 mx-auto max-w-[450px] xs:max-w-[600px] sm:max-w-[800px] md:max-w-[1460px]">
			<div className="flex justify-between">
				<div className="w-[690px]">
					<h1 className="font-bold mb-8 text-[44px] leading-none">
						Bukhara Natural Product
					</h1>
					<p className="text-[19px] tracking-wider leading-8 text-black/70">
				...
				<img
					className="w-[700px] h-[75vh] rounded-[15px] shadow-2xl"
